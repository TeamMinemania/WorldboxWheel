var students = [
  { name: 'Spawn 20 sheep' },
  { name: 'Spawn 10 dwarves' },
  { name: 'Spawn 20 chickens' },
  { name: 'Divine' },
  { name: 'Spawn 1 white wizard' },
  { name: 'Geyser' },
  { name: 'Rain for 5 seconds' },
  { name: 'Spawn 20 rabbits' },
  { name: 'Snow cloud' },
  { name: 'Spawn 20 cheeky monkeys' },
  { name: 'Spawn 20 crabs' },
  { name: 'Spawn 1 plague doctor' },
  { name: 'Magic cloud' },
  { name: 'Coffee' },
  { name: 'Spawn 20 dogs' },
  { name: 'Spawn 20 frogs' },
  ...
  { name: 'Rain cloud' },
  { name: 'Spawn 20 cows' },
  { name: 'Spawn 20 Penguins' },
  { name: 'Spawn 10 elves' },
  { name: 'Spawn 5 Fairies' },
  { name: 'Shield' },
  { name: 'Spawn 20 Cats' },
  { name: 'Blood rain 5 seconds.' },
  { name: 'Powerup' },
  { name: 'Spawn 10 humans' },
  { name: 'Fireworks' },
  { name: 'Spawn 1 druid' },
  { name: 'Spawn 20 turtles' },
  { name: 'Blessing' }
]
