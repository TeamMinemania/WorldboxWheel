var students = [
  { name: 'Spawn 1 ice tower' },
  { name: 'Zombie Infection 5 seconds' },
  { name: 'Earthquake' },
  { name: 'Volcano' },
  { name: 'Napalm bomb' },
  { name: 'Atomic bomb' },
  { name: 'Lava cloud' },
  { name: 'Robot santa' },
  { name: 'Spawn 10 skeletons' },
  { name: 'Rage cloud' },
  { name: 'Antimatter bomb' },
  { name: 'Crabzilla for 10 seconds' },
  { name: 'Waterbomb' },
  { name: 'Meteorite' },
  { name: 'Spawn 2 cold ones' },
  { name: 'Spawn 1 necromancer' },
  { name: 'Spawn 1 flame tower' },
  { name: 'Acid cloud' },
  { name: 'Add energised trait' },
  { name: 'Spawn 5 crocodiles' },
  { name: 'Temp down 5 seconds' },
  { name: 'Infinity coin' },
  { name: 'Fire for 5 seconds' },
  { name: 'Spawn 1 UFO' },
  { name: 'Plague 5 Seconds' },
  { name: 'Landmine' },
  { name: 'Spawn 1 cybercore' },
  { name: 'Delayed TNT' },
  { name: 'Spawn 1 evil mage' },
  { name: 'Add mark for death trait' },
  { name: 'Crab bomb' },
  { name: 'Add mega heartbeat trait' },
  { name: 'Spawn 1 super pumpkin' },
  { name: 'Spawn 1 biomass' },
  { name: 'Bomb' },
  { name: 'Spawn 3 snowmen' },
  { name: 'Lava for 5 seconds' },
  { name: 'Tsar Bomba' },
  { name: 'TNT' },
  { name: 'Acid for 5 Seconds' },
  { name: 'Grenade' },
  { name: 'Add death bomb trait' },
  { name: 'Living houses' },
  { name: 'Mush spares 5 seconds' },
  { name: 'Add death nuke trait' },
  { name: 'Spawn 10 wolves' },
  { name: 'Acid Geyser' },
  { name: 'Curse' },
  { name: 'Heat ray' },
  { name: 'Add pyromaniac trait' },
  { name: 'Spawn 20 rats' },
  { name: 'Spawn 5 bears' },
  { name: 'Temp up 5 seconds' },
  { name: 'Spawn 1 Dragon' },
  { name: 'Ash cloud' },
  { name: 'Spawn 20 Hyena' },
  { name: 'Grey goo' },
  { name: 'Add whirlwind trait' },
  { name: 'Madness 5 Seconds' },
  { name: 'Spawn 10 Zombies' },
  { name: 'Spawn 1 Tumor' },
  { name: 'Spawn 2 bandits' },
  { name: 'Spawn 10 orcs' },
  { name: 'Spawn 5 rat kings' },
  { name: 'Living plants' },
  { name: 'Spawn 2 demons' },
  { name: 'Spawn 20 snakes' },
  { name: '10 Bowling balls' },
  { name: 'Spawn 1 corrupted brain' },
  { name: 'Force' },
  { name: 'Lightning' },
  { name: 'Tornado' }
];
